...
// RP2040 SWD multi-drop TARGETSEL values
#define RP2040_CORE0_TARGETSEL  0x01002927U
#define RP2040_CORE1_TARGETSEL  0x11002927U
#define RP2040_RESCUE_TARGETSEL 0xF1002927U

// 烧录按键
#define BURN_KEY_GPIO_PIN (GPIO_NUM_42)
